...
# PARAMETERS LIVE IN frame_params.py, and are imported rather than
# defined here, so that assembly_v0.py uses the SAME numbers instead of
# a copy. `import *` is deliberate: this file used to define these at
# module scope and hundreds of lines below depend on the bare names.
from frame_params import *          # noqa: F401,F403
