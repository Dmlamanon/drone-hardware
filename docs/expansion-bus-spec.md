...
| Magnetometer | **I2C** | QMC5883L / IST8310-class | Sub-mA class, exact figure not independently confirmed this pass — see note below | [QST QMC5883L datasheet](https://qstcorp.com/upload/pdf/202202/13-52-04%20QMC5883L%20Datasheet%20Rev.%20A(1).pdf) (interface confirmed; current-consumption table not successfully fetched as readable text this batch — flagged, not fabricated) |
